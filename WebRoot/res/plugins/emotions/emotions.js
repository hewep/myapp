...
* @author hewep
*******************************************************************************/
define(['kindEditor'], function(kindEditor){
	var path = "res/plugins/kindeditor/plugins/emoticons/images/",
		currentPageNum = 1,
		K = KindEditor;
	
	function EmotionsEditor(obj, name){
		...
		function bindCellEvent(cell, j, num) {
			...
			cell.click(function(e) {
				obj.html('<img src="' + path + num + '.gif" border="0" alt="" />');
				menuDiv.hide();
				e.stop();
			});
		}
		...
		function createPageTable(currentPageNum) {
			...
			menuDiv.css({left:(offset.left)+"px", top:(offset.top + obj.outerHeight())+ "px"});
			obj.append(menuDiv);
		}
		
		createPageTable(currentPageNum);
	};
	return EmotionsEditor;
});
