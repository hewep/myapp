...
(function(mod) {
  ...
  var basePath = (function() {
	    ...
	    {
	    	var src = es[i].src;
	        if (src.substring(src.lastIndexOf("/")+1) == "codemirror.js")
	        {
	            result = src.substring(0,src.lastIndexOf("/lib")+1);
	            break;
	        }
	    }
  ...
  CodeMirror.loadModule = function(modules, onLoad){
//	  $.each(modules, function(i, item){
//		  item += ".js";
//		  modules.splice(i, 1, basePath+item);
//	  });
	  require(modules, function(){
		  onLoad();
	  });
  }
  function loadScript(modules, onLoad){
	  if(modules.length > 0){
		  var is_load = modules.length == 1;
		  var module = modules.pop();
		  $.getScript(module, function(){
			  loadScript(modules, onLoad);
			  if(is_load){
				  onLoad();
			  }
		  });
