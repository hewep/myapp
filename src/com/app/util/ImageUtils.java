...
public class ImageUtils {
 ...
 public final static void scale2(String srcImageFile, String result, int height, int width, boolean bb) {
    ...
    public final static void cut(String srcImageFile, String destImageFile, 
    		int x, int y, int width, int height, int viewHeight){
    	try {
    		BufferedImage bi = ImageIO.read(new File(srcImageFile));
	        int srcHeight = bi.getHeight(); // 源图宽度
	        
	        double scale = srcHeight /(float)viewHeight;
	        x = (int) (x*scale);
	        y = (int) (y * scale);
	        width = (int) (width * scale);
	        height = (int) (height * scale);
	        
	        cut(srcImageFile, destImageFile, x, y, width, height);
